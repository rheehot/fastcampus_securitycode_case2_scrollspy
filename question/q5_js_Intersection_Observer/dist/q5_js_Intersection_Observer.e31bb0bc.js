...
const scrollSpyObserver = new IntersectionObserver(entries => {
  ...
  const index = contentItems.indexOf(target); // console.log(index);

  Array.from(navElem.children).forEach((c, i) => {
    if (i === index) c.classList.add("on");else c.classList.remove("on");
  });
}, {
  root: null,
  rootMargin: "0px",
...
//# sourceMappingURL=/q5_js_Intersection_Observer.e31bb0bc.js.map